import { BaseIconOptions, CircleMarker, CircleMarkerOptions, DivOverlay, Icon, LatLngExpression, Point, Util } from 'leaflet';
...
export class SvgPathIcon extends Icon<SvgPathIconOptions> {
  ...
  adjustDivPosition(divEl: HTMLDivElement) {
