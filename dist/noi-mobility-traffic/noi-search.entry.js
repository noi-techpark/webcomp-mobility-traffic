import { r as registerInstance, h, e as Host, f as getAssetPath } from './index-eae66176.js';
...
const Search = class {
  ...
  render() {
    return (h(Host, null, h("div", { class: "noi-search__img" }), h("div", { class: "noi-search__inputs" }, h("noi-input", { placeholder: "Partenza?" }), h("hr", null), h("noi-input", { placeholder: "Destinazione?" })), h("div", { class: "noi-search__button" }, h("noi-button", { fill: "solid" }, h("img", { slot: "icon-only", src: getAssetPath(`./assets/reorder.svg`) })))));
  }
};
