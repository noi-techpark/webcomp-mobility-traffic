...
const StationsModal = class {
  ...
  render() {
    ...
    return (h(Host, { class: hostClass, style: hostStyle }, h("div", { class: "wrapper" }, h("header", null, h("noi-button", { fill: "clear", onClick: this.onClose.bind(this) }, h("img", { slot: "icon-only", class: "header__icon", src: getAssetPath('./assets/back.svg'), alt: "Indietro" })), h("span", { class: "header__title" }, this.getTitle())), h("div", { class: "search" }, h("noi-input", { debounce: 100, onNoiChange: this.onSearchChange.bind(this), placeholder: `A22 station?` })), h("div", { class: "list" }, this.renderStations()))));
  }
