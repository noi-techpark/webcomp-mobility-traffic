...
const NoiMap = class {
  ...
  userLatHandler(newValue, _oldValue) {
    this.userLat = newValue;
    this.updateUserMarker();
  }
  userLongHandler(newValue, _oldValue) {
  ...
  updateUserMarker() {
    ...
    if (!this.userMarker) {
      this.userMarker = leafletSrc.marker([this.userLat, this.userLong]);
  ...
  getHighwayStationLayer(e) {
    ...
    const circle = leafletSrc.circleMarker([lat, long], opts);
    if (e.textContent) {
  ...
  static get watchers() { return {
    ...
    "long": ["longHandler"],
    "scale": ["scaleHandler"],
    "userLat": ["userLatHandler"],
    "userLong": ["userLongHandler"]
  }; }
};
NoiMap.style = mapCss;
