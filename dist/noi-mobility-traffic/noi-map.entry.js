...
const NoiMap = class {
  ...
  renderGeoJson(e) {
    ...
    const layer = new leafletSrc.GeoJSON(geometry, geometry);
  ...
  renderSetAsStartButton() {
    ...
    const title = state.startId ? "Change origin" : "Set origin";
    return (h("noi-button", { fill: "solid", class: "button-md noi-map-station-popup__btn", onClick: this.onSetAsStart.bind(this) }, title));
  }
  renderSetAsEndButton() {
    if (state.selectedId === state.endId) {
      return null;
    }
    const title = state.endId ? "Change destination" : "Set destination";
    return (h("noi-button", { fill: "solid", class: "button-md noi-map-station-popup__btn", onClick: this.onSetAsEnd.bind(this) }, title));
  }
  renderSelectedStationPopup() {
    return (h("div", { class: "noi-map-station-popup" }, h("div", { class: "noi-map-station-popup__header" }, state.selected.name), h("div", { class: "noi-map-station-popup__content" }, this.renderSetAsStartButton(), this.renderSetAsEndButton())));
  }
  render() {
    return h("div", { class: "noi-map-popup", ref: (el) => this.popupElement = el }, state.selectedId ? this.renderSelectedStationPopup() : null);
  }
