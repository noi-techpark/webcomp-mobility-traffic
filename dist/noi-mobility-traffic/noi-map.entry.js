...
const NoiMap = class {
  ...
  onSetAsStart() {
    this.map.closePopup();
    alert(state.selected.name + ' is now start!');
    state.start = state.selected;
    state.selectedId = '';
  }
  onSetAsEnd() {
    this.map.closePopup();
    alert(state.selected.name + ' is now end!');
    state.end = state.selected;
    state.selectedId = '';
  }
  renderSelectedStationPopup() {
    return (h("div", { class: "noi-map-station-popup" }, h("div", { class: "noi-map-station-popup__header" }, state.selected.name), h("noi-button", { expand: "full", fill: "solid", class: "button-md noi-map-station-popup__btn", onClick: this.onSetAsStart.bind(this) }, "Set as start"), h("noi-button", { expand: "full", fill: "solid", class: "button-md noi-map-station-popup__btn", onClick: this.onSetAsEnd.bind(this) }, "Set as end")));
  }
  render() {
