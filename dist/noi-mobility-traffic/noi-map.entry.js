...
import { s as state } from './index-ccdc1066.js';
...
const NoiMap = class {
  ...
  renderSetAsStartButton() {
    ...
    const title = 'Da qui';
    return (h("noi-button", { fill: "solid", class: "button-md station-popup__btn", onClick: this.onSetAsStart.bind(this) }, title));
  }
  ...
  render() {
    ...
    this.updatePopupVisibility(!!state.selectedId);
    return h("div", { class: popupClass, ref: (el) => this.popupElement = el }, state.selectedId || this.showPopup ? this.renderSelectedStationPopup() : null);
  }
